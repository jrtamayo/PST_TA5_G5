    ...
    String[][] datoster = {
            {"Titulo: Frankenstein", "Autor: Marry Shelly", "Editorial: Lackington",
                    "SINOPSIS:\n Frankenstein es una historia macabra en la que Víctor, un joven ávido de conocimientos científicos, "+
                            ...
                            "Su éxito será su condena, la creación de un monstruo estremecedor que, "+ 
                            "n respuesta a su rechazo por todos se entrega por completo a "+
                            "saciar una sed de venganza hacia su creador, culpable de su desgracia, "+
                            "y hacia todo lo que éste ama, tornando en muerte todo "+
                            "alrededor de Víctor. El monstruo, "+
                            "enfermo de soledad, solicita una compañera a su creador a cambio de desaparecer para siempre, "+
                            "pero Víctor se niega a ello, provocando así que la única salida hacia la"+
                            "paz y el descanso sea el fin de uno de los dos."},
            ...
            {"Título: El misterio de Salem's Lot", "Autor: Stephen King", "Editorial: Doubleday",
                    "SINOPSIS \n Salem's Lot es un pueblo tranquilo donde nunca pasa nada. O quizás esto son solo apariencias, "+
                            ...
                            "excepto la antigua tragedia de la casa de los Marsten. Y el perro muerto colgado de la verja del cementerio."+
